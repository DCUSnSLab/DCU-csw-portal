    ...
    <div class="inner">
        <div class="l_cont">
            <div class="top_cont" >
                ...
                <ul class="type">
                    <li class="tab-link on" data-tab="tab1">공지사항</li>
                    <li class="tab-link" data-tab="tab2">교내소식</li>
                    <li class="tab-link" data-tab="tab3">채용공고</li>
                </ul>
            </div>
            <div class="cont">
                <div class="tabs">
                    <div id="tab1" class="tab-content on">
                        <div class="info">
                            <?=latest("theme/notice_lastest","테이블명", 5, 100);?>
                        </div>
                    </div>
