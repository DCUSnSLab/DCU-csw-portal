...
<form name="fwrite" id="fwrite" action="<?php echo $board_skin_url ?>/sh_setup_update.php" method="post" enctype="multipart/form-data" autocomplete="off">
  ...
  <table class="basicset">
    ...
    <tr>
      <th>출력순서</th>
      <td><input type="checkbox" name="bo_6" value="1" <?= get_checked($board['bo_6'],'1') ?> id="bo_6"/></td>
    ...
    <tr>
      <th><label for="bo_1">수강료조회 게시판명</label></th>
      <td colspan="3"><input type="text" name="bo_1" id="bo_1" value="<?= $board['bo_1'] ?>" class="frm_input"><br>※미입력 시 수강료 조회 관련 부분 미노출</td>
    </tr>
    <tr>
      <th>분류 ( 구분자| )</th>
      <td colspan="3">
