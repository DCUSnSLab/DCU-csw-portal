                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="sh_zip" value="<?php echo $write['sh_zip']; ?>" id="sh_zip" class="sh_input read zip_input" size="5" maxlength="6" readonly>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="wr_email" value="<?php echo $email ?>" id="wr_email" class="sh_input email" maxlength="100"></td>
                    </tr>
                    <?php } ?>
