...
include_once(G5_THEME_PATH.'/menu_set/designkits_menu.php');
...
if (G5_IS_MOBILE) {
	...
	echo '<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=yes">'.PHP_EOL; // 모바일일때 확대방지
...
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/sh_common.css?ver='.G5_CSS_VER.'">', 0);
if (G5_IS_MOBILE) {	
	echo '<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/sh_common_m.css?ver='.G5_CSS_VER.'">'.PHP_EOL;
}
?>
<!--[if lte IE 8]>
