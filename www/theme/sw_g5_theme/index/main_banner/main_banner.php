            ...
            <div class="link_box">
                ...
                <div class="collge">
                    <ul>
                        <li>
                            <a href="">
                                <img src="<?= $sh_inc_url ?>/img/collge_icon01__.png" alt="수시모집">
                                <p>수시모집</p>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?= $sh_inc_url ?>/img/collge_icon02__.png" alt="정시모집">
                                <p>정시모집</p>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?= $sh_inc_url ?>/img/collge_icon03__.png" alt="대학원모집">
                                <p>대학원모집</p>
                            </a>
                        </li>
                    </ul>
