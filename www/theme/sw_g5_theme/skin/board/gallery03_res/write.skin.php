        ...
        <div id="sh_write_tbl" class="sh_tbl_common">
            <table cellpadding="0" cellspacing="0" summary="<?php echo $board['bo_subject'] ?> 글쓰기">
                ...
                <tbody>
                    ...
                    <?php if($board['bo_7'] == '1'){?>
                    <tr>
                        <th><label for="sh_video">동영상<br />소스코드</label></th>
                        <td><textarea type="text" name="sh_video" id="sh_video" class="sh_input txtarea"><?php echo $write['sh_video'] ?></textarea><p class="ps">※ iframe 형식의 코드만 넣어주세요.</p></td>
                    </tr>
                    <?php } ?>
